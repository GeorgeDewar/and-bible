package net.bible.service.pocketsphinx;
...
public class RecognizerTask implements Runnable {
	...
	public RecognizerTask(String hmm, String lm, String dict) {
		...
		String dataDirectory = Environment.getExternalStorageDirectory().getPath() + "/Android/data/edu.cmu.pocketsphinx/"; 
		
		c.setString("-hmm", dataDirectory + "/hmm/" + hmm);
		c.setString("-dict", dataDirectory + "/lm/" + dict);
		c.setString("-lm", dataDirectory + "/lm/" + lm);
